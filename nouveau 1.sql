"SELECT S.idStage, S.idEntreprise, S.description, S.dateValidation, S.idEleve, EL.nom, EL.prenom, R.nom, R.prenom, R.fonction, R.telFixe, R.telPortable, R.mail, ET.raisonSociale, ET.activite, L.adresse, L.adresse2, L.ville, L.pays, L.numTel, L.numFax
